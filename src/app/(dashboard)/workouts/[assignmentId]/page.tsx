    ...
    const leftSidebarContent = (
        <div className="p-4 lg:p-5">
            <div className="flex flex-wrap gap-3 items-stretch">
                <div className="w-full min-w-0 sm:min-w-[240px] sm:flex-1 items-center gap-3 rounded-2xl border border-endurix-black/10 dark:border-white/10 bg-white/70 dark:bg-white/5 p-4 flex">
                ...
                {assignment.canEdit && !assignment.completed && (
                    <div className="w-full min-w-0 sm:min-w-[360px] sm:flex-[2] items-center gap-3 rounded-2xl border border-endurix-orange/20 bg-endurix-orange/5 p-4 flex flex-col sm:flex-row">
                ...
                <div className="w-full min-w-0 sm:min-w-[280px] sm:flex-1 items-center gap-3 rounded-2xl border border-endurix-black/10 dark:border-white/10 bg-white/70 dark:bg-white/5 p-4 flex">
